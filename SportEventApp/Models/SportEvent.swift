...
//    var sport: Sport
//
//    init(eventCoverName: String? = nil, title: String, description: String, date: Date, firstTeam: String, secondTeam: String, sport: Sport, teams: [Team]) {
//        self.sport = sport
//        self.teams = teams
//        super.init(eventCoverName: eventCoverName, title: title, description: description, date: date, firstTeam: firstTeam, secondTeam: secondTeam)
//    }
//
