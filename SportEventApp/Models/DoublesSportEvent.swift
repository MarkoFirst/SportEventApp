...
class DoublesSportEvent: SportEvent {
    ...
    convenience init(title: String, desc: String, date: Date, place: Place?, currency: CurrencyList.RawValue, icon: Data, typeOfSport: TypeOfSport, athletes: List<Athlete>) {
